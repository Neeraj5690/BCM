...
MdataSheetTab = "test_Smoke_Approvals_Manager"
PageName = "Approvals"
...
def test_AllModules(test_setup):
    if Exe == "Yes":
        try:
            ...
            PageTitleExpected = "Approvals - Demo - Benefits Coverage Manager"
            ...
            if SafeToClick=="Yes":
                ...
                # -------------------Pagination Clicks-------------------------
                ElementVerify ="Pagination clicks under product plans table"
